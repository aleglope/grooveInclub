  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        {/* add des prop */}
        <Card
          title="Y QUE EL SOL NOS PILLE BAILANDO"
          icon={<AceternityIcon order="DANCE" />}
          des="De la cama a la pista de baile. Sleep, Rave, Repeat."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          title="PUNCHIKIPUMPUMPUMAPISPIUPUMMMMM"
        ...
        <Card
          ...
          Desde el momento en que cruzas nuestras puertas, te envuelve una atmósfera vibrante y llena de vida.
          Los DJs te llevan en un viaje sonoro que te atrapa en un bucle de pura felicidad.
          Cada repetición es una nueva aventura, una oportunidad de explorar nuevos sonidos y crear recuerdos duraderos.."
        >
          <CanvasRevealEffect
            animationSpeed={3}
